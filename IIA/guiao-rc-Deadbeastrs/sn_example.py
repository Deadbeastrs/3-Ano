...
teste = Declaration('teste',Subtype('lol','mamifero'))
teste1 = Declaration('teste',Member('peixe','lol'))
...
#print(z.associations_by_user('descartes'))
#print(z.list_local_associations_by_user('socrates'))
#print(z.predecessor('vertebrado','peixe'))
